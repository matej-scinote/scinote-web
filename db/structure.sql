...
--
-- Name: asset_sync_tokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.asset_sync_tokens (
    id bigint NOT NULL,
...
--
-- Name: asset_sync_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.asset_sync_tokens_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: asset_sync_tokens_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.asset_sync_tokens_id_seq OWNED BY public.asset_sync_tokens.id;
...
--
-- Name: form_field_values; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.form_field_values (
    ...
    datetime_to timestamp(6) without time zone,
    number numeric,
    number_to numeric,
    unit text,
    text text,
...
--
-- Name: form_field_values_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.form_field_values_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: form_field_values_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.form_field_values_id_seq OWNED BY public.form_field_values.id;
...
CREATE TABLE public.form_responses (
    ...
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL,
    previous_form_response_id bigint,
...
--
-- Name: protocol_repository_rows; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.protocol_repository_rows (
    id bigint NOT NULL,
    protocol_id bigint NOT NULL,
...
--
-- Name: protocol_repository_rows_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.protocol_repository_rows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: protocol_repository_rows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.protocol_repository_rows_id_seq OWNED BY public.protocol_repository_rows.id;
...
CREATE TABLE public.repositories (
    ...
    repository_rows_count integer DEFAULT 0 NOT NULL,
    repository_template_id bigint
);
...
--
-- Name: repository_row_connections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.repository_row_connections (
    id bigint NOT NULL,
    ...
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL,
    CONSTRAINT constraint_repository_row_connections_on_self_connection CHECK ((parent_id <> child_id))
);


--
-- Name: repository_row_connections_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.repository_row_connections_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: repository_row_connections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.repository_row_connections_id_seq OWNED BY public.repository_row_connections.id;
...
CREATE TABLE public.repository_rows (
    ...
    restored_by_id bigint,
    external_id character varying,
    parent_connections_count integer,
    child_connections_count integer,
    my_module_id bigint
);
...
--
-- Name: repository_templates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.repository_templates (
    id bigint NOT NULL,
    name character varying,
...
--
-- Name: repository_templates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.repository_templates_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: repository_templates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.repository_templates_id_seq OWNED BY public.repository_templates.id;
...
CREATE TABLE public.repository_text_values (
    ...
    created_by_id bigint NOT NULL,
    last_modified_by_id bigint NOT NULL,
    has_smart_annotation boolean DEFAULT false NOT NULL
);
...
--
-- Name: result_orderable_elements; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.result_orderable_elements (
    id bigint NOT NULL,
    result_id bigint NOT NULL,
    "position" integer NOT NULL,
...
--
-- Name: result_orderable_elements_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.result_orderable_elements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: result_orderable_elements_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.result_orderable_elements_id_seq OWNED BY public.result_orderable_elements.id;
...
CREATE TABLE public.results (
    ...
    restored_by_id bigint,
    restored_on timestamp without time zone,
    assets_view_mode integer DEFAULT 0,
    discarded_at timestamp(6) without time zone,
    type character varying,
    protocol_id bigint,
...
CREATE SEQUENCE public.step_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.step_results_id_seq OWNED BY public.step_results.id;
...
--
-- Name: storage_location_repository_rows; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.storage_location_repository_rows (
    id bigint NOT NULL,
    repository_row_id bigint,
...
--
-- Name: storage_location_repository_rows_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.storage_location_repository_rows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: storage_location_repository_rows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.storage_location_repository_rows_id_seq OWNED BY public.storage_location_repository_rows.id;
...
CREATE TABLE public.webhooks (
    ...
    include_serialized_subject boolean DEFAULT false NOT NULL
);
...
ALTER TABLE ONLY public.asset_sync_tokens ALTER COLUMN id SET DEFAULT nextval('public.asset_sync_tokens_id_seq'::regclass);
...
--
-- Name: form_field_values id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_field_values ALTER COLUMN id SET DEFAULT nextval('public.form_field_values_id_seq'::regclass);
...
--
-- Name: protocol_repository_rows id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.protocol_repository_rows ALTER COLUMN id SET DEFAULT nextval('public.protocol_repository_rows_id_seq'::regclass);
...
--
-- Name: repository_row_connections id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_row_connections ALTER COLUMN id SET DEFAULT nextval('public.repository_row_connections_id_seq'::regclass);
...
--
-- Name: repository_templates id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_templates ALTER COLUMN id SET DEFAULT nextval('public.repository_templates_id_seq'::regclass);
...
--
-- Name: result_orderable_elements id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_orderable_elements ALTER COLUMN id SET DEFAULT nextval('public.result_orderable_elements_id_seq'::regclass);
...
--
-- Name: step_results id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.step_results ALTER COLUMN id SET DEFAULT nextval('public.step_results_id_seq'::regclass);
...
--
-- Name: storage_location_repository_rows id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_location_repository_rows ALTER COLUMN id SET DEFAULT nextval('public.storage_location_repository_rows_id_seq'::regclass);
...
--
-- Name: asset_sync_tokens asset_sync_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_sync_tokens
    ADD CONSTRAINT asset_sync_tokens_pkey PRIMARY KEY (id);
...
--
-- Name: form_field_values form_field_values_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: protocol_repository_rows protocol_repository_rows_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.protocol_repository_rows
    ADD CONSTRAINT protocol_repository_rows_pkey PRIMARY KEY (id);
...
--
-- Name: repository_row_connections repository_row_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_row_connections
    ADD CONSTRAINT repository_row_connections_pkey PRIMARY KEY (id);
...
--
-- Name: repository_templates repository_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_templates
    ADD CONSTRAINT repository_templates_pkey PRIMARY KEY (id);
...
--
-- Name: result_orderable_elements result_orderable_elements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_orderable_elements
    ADD CONSTRAINT result_orderable_elements_pkey PRIMARY KEY (id);
...
--
-- Name: storage_location_repository_rows storage_location_repository_rows_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_location_repository_rows
    ADD CONSTRAINT storage_location_repository_rows_pkey PRIMARY KEY (id);
...
CREATE UNIQUE INDEX idx_on_protocol_id_repository_row_id_8e60521e65 ON public.protocol_repository_rows USING btree (protocol_id, repository_row_id);
...
CREATE INDEX index_asset_sync_tokens_on_asset_id ON public.asset_sync_tokens USING btree (asset_id);


--
-- Name: index_asset_sync_tokens_on_token; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_asset_sync_tokens_on_token ON public.asset_sync_tokens USING btree (token);


--
-- Name: index_asset_sync_tokens_on_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_asset_sync_tokens_on_user_id ON public.asset_sync_tokens USING btree (user_id);
...
--
-- Name: index_assets_on_archived; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_assets_on_archived ON public.assets USING btree (archived);


--
-- Name: index_assets_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_assets_on_archived_by_id ON public.assets USING btree (archived_by_id);
...
CREATE INDEX index_assets_on_restored_by_id ON public.assets USING btree (restored_by_id);
...
--
-- Name: index_checklist_items_on_checklist_id_and_position; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_checklist_items_on_checklist_id_and_position ON public.checklist_items USING btree (checklist_id, "position");
...
--
-- Name: index_checklists_on_archived; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_checklists_on_archived ON public.checklists USING btree (archived);


--
-- Name: index_checklists_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_checklists_on_archived_by_id ON public.checklists USING btree (archived_by_id);
...
--
-- Name: index_checklists_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_checklists_on_restored_by_id ON public.checklists USING btree (restored_by_id);
...
--
-- Name: index_favorites_on_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_favorites_on_item ON public.favorites USING btree (item_type, item_id);


--
-- Name: index_favorites_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_favorites_on_team_id ON public.favorites USING btree (team_id);


--
-- Name: index_favorites_on_user_and_item_and_team; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_favorites_on_user_and_item_and_team ON public.favorites USING btree (user_id, team_id, item_id, item_type);
...
--
-- Name: index_form_field_values_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_field_values_on_created_by_id ON public.form_field_values USING btree (created_by_id);


--
-- Name: index_form_field_values_on_form_field_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_field_values_on_form_field_id ON public.form_field_values USING btree (form_field_id);


--
-- Name: index_form_field_values_on_form_response_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_field_values_on_form_response_id ON public.form_field_values USING btree (form_response_id);


--
-- Name: index_form_field_values_on_search_data; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_field_values_on_search_data ON public.form_field_values USING gin (public.trim_html_tags(search_data) public.gin_trgm_ops);


--
-- Name: index_form_field_values_on_submitted_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_field_values_on_submitted_by_id ON public.form_field_values USING btree (submitted_by_id);


--
-- Name: index_form_field_values_on_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_field_values_on_type ON public.form_field_values USING btree (type);


--
-- Name: index_form_fields_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_fields_on_created_by_id ON public.form_fields USING btree (created_by_id);
...
--
-- Name: index_form_fields_on_last_modified_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_fields_on_last_modified_by_id ON public.form_fields USING btree (last_modified_by_id);


--
-- Name: index_form_responses_on_archived; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_archived ON public.form_responses USING btree (archived);


--
-- Name: index_form_responses_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_archived_by_id ON public.form_responses USING btree (archived_by_id);


--
-- Name: index_form_responses_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_created_by_id ON public.form_responses USING btree (created_by_id);


--
-- Name: index_form_responses_on_form_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_form_responses_on_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_parent ON public.form_responses USING btree (parent_type, parent_id);


--
-- Name: index_form_responses_on_previous_form_response_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_previous_form_response_id ON public.form_responses USING btree (previous_form_response_id);


--
-- Name: index_form_responses_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_restored_by_id ON public.form_responses USING btree (restored_by_id);


--
-- Name: index_form_responses_on_submitted_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_form_responses_on_submitted_by_id ON public.form_responses USING btree (submitted_by_id);


--
-- Name: index_forms_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_archived_by_id ON public.forms USING btree (archived_by_id);


--
-- Name: index_forms_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_created_by_id ON public.forms USING btree (created_by_id);


--
-- Name: index_forms_on_default_public_user_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_default_public_user_role_id ON public.forms USING btree (default_public_user_role_id);


--
-- Name: index_forms_on_last_modified_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_last_modified_by_id ON public.forms USING btree (last_modified_by_id);


--
-- Name: index_forms_on_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_parent_id ON public.forms USING btree (parent_id);


--
-- Name: index_forms_on_published_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_published_by_id ON public.forms USING btree (published_by_id);


--
-- Name: index_forms_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_restored_by_id ON public.forms USING btree (restored_by_id);


--
-- Name: index_forms_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_team_id ON public.forms USING btree (team_id);


--
-- Name: index_forms_on_visibility; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_forms_on_visibility ON public.forms USING btree (visibility);
...
CREATE INDEX index_projects_on_description ON public.projects USING gin (public.trim_html_tags(description) public.gin_trgm_ops);
...
--
-- Name: index_projects_on_supervised_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_projects_on_supervised_by_id ON public.projects USING btree (supervised_by_id);
...
--
-- Name: index_protocol_repository_rows_on_repository_row_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_protocol_repository_rows_on_repository_row_id ON public.protocol_repository_rows USING btree (repository_row_id);
...
--
-- Name: index_repositories_on_repository_template_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repositories_on_repository_template_id ON public.repositories USING btree (repository_template_id);
...
--
-- Name: index_repository_row_connections_on_child_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repository_row_connections_on_child_id ON public.repository_row_connections USING btree (child_id);


--
-- Name: index_repository_row_connections_on_connection_pair; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_repository_row_connections_on_connection_pair ON public.repository_row_connections USING btree (LEAST(parent_id, child_id), GREATEST(parent_id, child_id));


--
-- Name: index_repository_row_connections_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repository_row_connections_on_created_by_id ON public.repository_row_connections USING btree (created_by_id);


--
-- Name: index_repository_row_connections_on_last_modified_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repository_row_connections_on_last_modified_by_id ON public.repository_row_connections USING btree (last_modified_by_id);


--
-- Name: index_repository_row_connections_on_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repository_row_connections_on_parent_id ON public.repository_row_connections USING btree (parent_id);
...
--
-- Name: index_repository_rows_on_my_module_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repository_rows_on_my_module_id ON public.repository_rows USING btree (my_module_id);
...
--
-- Name: index_repository_templates_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_repository_templates_on_team_id ON public.repository_templates USING btree (team_id);
...
--
-- Name: index_result_orderable_elements_on_orderable; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_result_orderable_elements_on_orderable ON public.result_orderable_elements USING btree (orderable_type, orderable_id);
...
--
-- Name: index_result_texts_on_archived; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_result_texts_on_archived ON public.result_texts USING btree (archived);


--
-- Name: index_result_texts_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_result_texts_on_archived_by_id ON public.result_texts USING btree (archived_by_id);
...
CREATE INDEX index_result_texts_on_name ON public.result_texts USING gin (public.trim_html_tags((name)::text) public.gin_trgm_ops);


--
-- Name: index_result_texts_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_result_texts_on_restored_by_id ON public.result_texts USING btree (restored_by_id);
...
--
-- Name: index_results_on_discarded_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_results_on_discarded_at ON public.results USING btree (discarded_at);
...
--
-- Name: index_results_on_pinned_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_results_on_pinned_by_id ON public.results USING btree (pinned_by_id);


--
-- Name: index_results_on_protocol_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_results_on_protocol_id ON public.results USING btree (protocol_id);
...
--
-- Name: index_shareable_links_on_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_shareable_links_on_uuid ON public.shareable_links USING btree (uuid);
...
--
-- Name: index_step_results_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_step_results_on_created_by_id ON public.step_results USING btree (created_by_id);


--
-- Name: index_step_results_on_result_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_step_results_on_result_id ON public.step_results USING btree (result_id);


--
-- Name: index_step_results_on_step_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_step_results_on_step_id ON public.step_results USING btree (step_id);
...
--
-- Name: index_step_texts_on_archived; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_step_texts_on_archived ON public.step_texts USING btree (archived);


--
-- Name: index_step_texts_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX index_step_texts_on_name ON public.step_texts USING gin (public.trim_html_tags((name)::text) public.gin_trgm_ops);


--
-- Name: index_step_texts_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_step_texts_on_restored_by_id ON public.step_texts USING btree (restored_by_id);
...
CREATE INDEX index_steps_on_archived ON public.steps USING btree (archived);


--
-- Name: index_steps_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: index_steps_on_original_protocol_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_steps_on_original_protocol_id ON public.steps USING btree (original_protocol_id);
...
--
-- Name: index_steps_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_steps_on_restored_by_id ON public.steps USING btree (restored_by_id);
...
--
-- Name: index_storage_location_repository_rows_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_location_repository_rows_on_created_by_id ON public.storage_location_repository_rows USING btree (created_by_id);


--
-- Name: index_storage_location_repository_rows_on_discarded_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_location_repository_rows_on_discarded_at ON public.storage_location_repository_rows USING btree (discarded_at);


--
-- Name: index_storage_location_repository_rows_on_repository_row_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_location_repository_rows_on_repository_row_id ON public.storage_location_repository_rows USING btree (repository_row_id);


--
-- Name: index_storage_location_repository_rows_on_storage_location_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_location_repository_rows_on_storage_location_id ON public.storage_location_repository_rows USING btree (storage_location_id);


--
-- Name: index_storage_locations_on_container; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_container ON public.storage_locations USING btree (container);


--
-- Name: index_storage_locations_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_created_by_id ON public.storage_locations USING btree (created_by_id);


--
-- Name: index_storage_locations_on_description; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_description ON public.storage_locations USING gin (public.trim_html_tags((description)::text) public.gin_trgm_ops);


--
-- Name: index_storage_locations_on_discarded_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_discarded_at ON public.storage_locations USING btree (discarded_at);


--
-- Name: index_storage_locations_on_name; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_name ON public.storage_locations USING gin (public.trim_html_tags((name)::text) public.gin_trgm_ops);


--
-- Name: index_storage_locations_on_parent_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_parent_id ON public.storage_locations USING btree (parent_id);


--
-- Name: index_storage_locations_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_storage_locations_on_team_id ON public.storage_locations USING btree (team_id);


--
-- Name: index_tables_on_archived; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tables_on_archived ON public.tables USING btree (archived);


--
-- Name: index_tables_on_archived_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tables_on_archived_by_id ON public.tables USING btree (archived_by_id);
...
--
-- Name: index_tables_on_restored_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_tables_on_restored_by_id ON public.tables USING btree (restored_by_id);
...
--
-- Name: index_taggings_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_taggings_on_created_by_id ON public.taggings USING btree (created_by_id);
...
--
-- Name: index_taggings_on_taggable_type_and_taggable_id_and_tag_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_taggings_on_taggable_type_and_taggable_id_and_tag_id ON public.taggings USING btree (taggable_type, taggable_id, tag_id);
...
--
-- Name: index_team_assignments_on_assignable; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_team_assignments_on_assignable ON public.team_assignments USING btree (assignable_type, assignable_id);


--
-- Name: index_team_assignments_on_assigned_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_team_assignments_on_assigned_by_id ON public.team_assignments USING btree (assigned_by_id);


--
-- Name: index_team_assignments_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_team_assignments_on_team_id ON public.team_assignments USING btree (team_id);


--
-- Name: index_team_assignments_on_unique_assignable_in_team; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_team_assignments_on_unique_assignable_in_team ON public.team_assignments USING btree (assignable_type, assignable_id, team_id);


--
-- Name: index_team_assignments_on_user_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_team_assignments_on_user_role_id ON public.team_assignments USING btree (user_role_id);
...
--
-- Name: index_user_assignments_assignable_type_team_user_user_role; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_assignments_assignable_type_team_user_user_role ON public.user_assignments USING btree (assignable_type, team_id, user_id, user_role_id);
...
--
-- Name: index_user_assignments_on_unique_assignable_in_team; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_user_assignments_on_unique_assignable_in_team ON public.user_assignments USING btree (assignable_type, assignable_id, user_id, team_id);
...
--
-- Name: index_user_group_assignments_on_assignable; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_group_assignments_on_assignable ON public.user_group_assignments USING btree (assignable_type, assignable_id);


--
-- Name: index_user_group_assignments_on_assigned_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_group_assignments_on_assigned_by_id ON public.user_group_assignments USING btree (assigned_by_id);


--
-- Name: index_user_group_assignments_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_group_assignments_on_team_id ON public.user_group_assignments USING btree (team_id);


--
-- Name: index_user_group_assignments_on_unique_assignable_in_team; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_user_group_assignments_on_unique_assignable_in_team ON public.user_group_assignments USING btree (user_group_id, assignable_type, assignable_id, team_id);


--
-- Name: index_user_group_assignments_on_user_group_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_group_assignments_on_user_group_id ON public.user_group_assignments USING btree (user_group_id);


--
-- Name: index_user_group_assignments_on_user_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_group_assignments_on_user_role_id ON public.user_group_assignments USING btree (user_role_id);


--
-- Name: index_user_group_memberships_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_group_memberships_on_created_by_id ON public.user_group_memberships USING btree (created_by_id);
...
--
-- Name: index_user_group_memberships_on_user_group_id_and_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_user_group_memberships_on_user_group_id_and_user_id ON public.user_group_memberships USING btree (user_group_id, user_id);
...
--
-- Name: index_user_groups_on_created_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_groups_on_created_by_id ON public.user_groups USING btree (created_by_id);


--
-- Name: index_user_groups_on_last_modified_by_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_groups_on_last_modified_by_id ON public.user_groups USING btree (last_modified_by_id);


--
-- Name: index_user_groups_on_lower_name_and_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_user_groups_on_lower_name_and_team_id ON public.user_groups USING btree (lower((name)::text), team_id);


--
-- Name: index_user_groups_on_team_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_groups_on_team_id ON public.user_groups USING btree (team_id);
...
--
-- Name: index_view_states_on_user_id_and_viewable_id_and_viewable_type; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_view_states_on_user_id_and_viewable_id_and_viewable_type ON public.view_states USING btree (user_id, viewable_id, viewable_type);
...
--
-- Name: unique_index_repositories_on_external_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX unique_index_repositories_on_external_id ON public.repositories USING btree (team_id, external_id);


--
-- Name: unique_index_repository_checklist_items_on_external_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX unique_index_repository_checklist_items_on_external_id ON public.repository_checklist_items USING btree (repository_column_id, external_id);


--
-- Name: unique_index_repository_list_items_on_external_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX unique_index_repository_list_items_on_external_id ON public.repository_list_items USING btree (repository_column_id, external_id);
...
CREATE UNIQUE INDEX unique_index_repository_rows_on_external_id ON public.repository_rows USING btree (repository_id, external_id);
...
--
-- Name: tables fk_rails_0b3a434cdc; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tables
    ADD CONSTRAINT fk_rails_0b3a434cdc FOREIGN KEY (archived_by_id) REFERENCES public.users(id);
...
--
-- Name: user_groups fk_rails_11024d5a1c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_groups
    ADD CONSTRAINT fk_rails_11024d5a1c FOREIGN KEY (team_id) REFERENCES public.teams(id);
...
--
-- Name: repository_row_connections fk_rails_143d2f68b4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_row_connections
    ADD CONSTRAINT fk_rails_143d2f68b4 FOREIGN KEY (last_modified_by_id) REFERENCES public.users(id);
...
--
-- Name: step_texts fk_rails_1510de1408; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.step_texts
    ADD CONSTRAINT fk_rails_1510de1408 FOREIGN KEY (archived_by_id) REFERENCES public.users(id);


--
-- Name: storage_location_repository_rows fk_rails_16003dde06; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_location_repository_rows
    ADD CONSTRAINT fk_rails_16003dde06 FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: checklists fk_rails_1e8a4ed29f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checklists
    ADD CONSTRAINT fk_rails_1e8a4ed29f FOREIGN KEY (archived_by_id) REFERENCES public.users(id);


--
-- Name: user_group_memberships fk_rails_1fc0fa3f43; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_memberships
    ADD CONSTRAINT fk_rails_1fc0fa3f43 FOREIGN KEY (created_by_id) REFERENCES public.users(id);


--
-- Name: repository_row_connections fk_rails_214d18741d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_row_connections
    ADD CONSTRAINT fk_rails_214d18741d FOREIGN KEY (child_id) REFERENCES public.repository_rows(id);
...
--
-- Name: form_responses fk_rails_2547203967; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_responses
    ADD CONSTRAINT fk_rails_2547203967 FOREIGN KEY (submitted_by_id) REFERENCES public.users(id);


--
-- Name: form_responses fk_rails_26cae434cc; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_responses
    ADD CONSTRAINT fk_rails_26cae434cc FOREIGN KEY (created_by_id) REFERENCES public.users(id);


--
-- Name: repository_rows fk_rails_275fa683a5; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_rows
    ADD CONSTRAINT fk_rails_275fa683a5 FOREIGN KEY (my_module_id) REFERENCES public.my_modules(id);
...
--
-- Name: forms fk_rails_2c1f5cff16; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_2c1f5cff16 FOREIGN KEY (parent_id) REFERENCES public.forms(id);
...
--
-- Name: forms fk_rails_2cc48ab563; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_2cc48ab563 FOREIGN KEY (default_public_user_role_id) REFERENCES public.user_roles(id);


--
-- Name: forms fk_rails_2d33d62990; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_2d33d62990 FOREIGN KEY (published_by_id) REFERENCES public.users(id);


--
-- Name: form_responses fk_rails_2d419fca47; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_responses
    ADD CONSTRAINT fk_rails_2d419fca47 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
...
--
-- Name: storage_location_repository_rows fk_rails_306114b475; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_location_repository_rows
    ADD CONSTRAINT fk_rails_306114b475 FOREIGN KEY (repository_row_id) REFERENCES public.repository_rows(id);


--
-- Name: steps fk_rails_30f4a718f7; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.steps
    ADD CONSTRAINT fk_rails_30f4a718f7 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
...
--
-- Name: repository_templates fk_rails_3225f25c96; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_templates
    ADD CONSTRAINT fk_rails_3225f25c96 FOREIGN KEY (team_id) REFERENCES public.teams(id);
...
--
-- Name: form_responses fk_rails_3579ee8750; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_responses
    ADD CONSTRAINT fk_rails_3579ee8750 FOREIGN KEY (form_id) REFERENCES public.forms(id);
...
--
-- Name: user_group_assignments fk_rails_38f8dac5b8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_assignments
    ADD CONSTRAINT fk_rails_38f8dac5b8 FOREIGN KEY (user_role_id) REFERENCES public.user_roles(id);


--
-- Name: checklists fk_rails_3ab11235da; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checklists
    ADD CONSTRAINT fk_rails_3ab11235da FOREIGN KEY (restored_by_id) REFERENCES public.users(id);


--
-- Name: asset_sync_tokens fk_rails_3c64363d03; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_sync_tokens
    ADD CONSTRAINT fk_rails_3c64363d03 FOREIGN KEY (asset_id) REFERENCES public.assets(id);


--
-- Name: form_responses fk_rails_3ccea004e5; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_responses
    ADD CONSTRAINT fk_rails_3ccea004e5 FOREIGN KEY (archived_by_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.projects
    ADD CONSTRAINT fk_rails_3d823f32bf FOREIGN KEY (supervised_by_id) REFERENCES public.users(id);
...
--
-- Name: storage_location_repository_rows fk_rails_3e925924e8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_location_repository_rows
    ADD CONSTRAINT fk_rails_3e925924e8 FOREIGN KEY (storage_location_id) REFERENCES public.storage_locations(id);


--
-- Name: step_results fk_rails_3f09949ede; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.step_results
    ADD CONSTRAINT fk_rails_3f09949ede FOREIGN KEY (result_id) REFERENCES public.results(id);


--
-- Name: form_fields fk_rails_41d7069877; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_fields
    ADD CONSTRAINT fk_rails_41d7069877 FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: asset_sync_tokens fk_rails_48a8482813; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_sync_tokens
    ADD CONSTRAINT fk_rails_48a8482813 FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: form_field_values fk_rails_4ca1161810; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_field_values
    ADD CONSTRAINT fk_rails_4ca1161810 FOREIGN KEY (form_response_id) REFERENCES public.form_responses(id);
...
--
-- Name: protocol_repository_rows fk_rails_4f073366ad; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.protocol_repository_rows
    ADD CONSTRAINT fk_rails_4f073366ad FOREIGN KEY (protocol_id) REFERENCES public.protocols(id);


--
-- Name: result_orderable_elements fk_rails_51c5f2b103; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_orderable_elements
    ADD CONSTRAINT fk_rails_51c5f2b103 FOREIGN KEY (result_id) REFERENCES public.results(id);


--
-- Name: assets fk_rails_530fc5ff44; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.assets
    ADD CONSTRAINT fk_rails_57eb23f6d3 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
...
--
-- Name: repositories fk_rails_5b0a697b4b; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repositories
    ADD CONSTRAINT fk_rails_5b0a697b4b FOREIGN KEY (repository_template_id) REFERENCES public.repository_templates(id);


--
-- Name: steps fk_rails_5b54491027; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.steps
    ADD CONSTRAINT fk_rails_5b54491027 FOREIGN KEY (archived_by_id) REFERENCES public.users(id);


--
-- Name: steps fk_rails_5c148681f9; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.steps
    ADD CONSTRAINT fk_rails_5c148681f9 FOREIGN KEY (original_protocol_id) REFERENCES public.protocols(id);
...
--
-- Name: step_results fk_rails_6955b7d93b; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.step_results
    ADD CONSTRAINT fk_rails_6955b7d93b FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: form_field_values fk_rails_6a1d556c8e; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: team_assignments fk_rails_6cb19fab3f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team_assignments
    ADD CONSTRAINT fk_rails_6cb19fab3f FOREIGN KEY (user_role_id) REFERENCES public.user_roles(id);
...
--
-- Name: team_assignments fk_rails_6d20d1ec55; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team_assignments
    ADD CONSTRAINT fk_rails_6d20d1ec55 FOREIGN KEY (assigned_by_id) REFERENCES public.users(id);
...
--
-- Name: storage_locations fk_rails_70a8636fe0; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_locations
    ADD CONSTRAINT fk_rails_70a8636fe0 FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: form_responses fk_rails_7dd195959f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_responses
    ADD CONSTRAINT fk_rails_7dd195959f FOREIGN KEY (previous_form_response_id) REFERENCES public.form_responses(id);
...
--
-- Name: user_group_assignments fk_rails_7ea62f0be4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_assignments
    ADD CONSTRAINT fk_rails_7ea62f0be4 FOREIGN KEY (assigned_by_id) REFERENCES public.users(id);
...
--
-- Name: forms fk_rails_870c111422; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_870c111422 FOREIGN KEY (archived_by_id) REFERENCES public.users(id);
...
--
-- Name: result_texts fk_rails_943af73068; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_texts
    ADD CONSTRAINT fk_rails_943af73068 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
...
--
-- Name: storage_locations fk_rails_97d8e0e23f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_locations
    ADD CONSTRAINT fk_rails_97d8e0e23f FOREIGN KEY (team_id) REFERENCES public.teams(id);
...
--
-- Name: favorites fk_rails_ac4a6e4b36; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.favorites
    ADD CONSTRAINT fk_rails_ac4a6e4b36 FOREIGN KEY (team_id) REFERENCES public.teams(id);
...
--
-- Name: tables fk_rails_b8e94aadb8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tables
    ADD CONSTRAINT fk_rails_b8e94aadb8 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
...
--
-- Name: repository_row_connections fk_rails_c061464343; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_row_connections
    ADD CONSTRAINT fk_rails_c061464343 FOREIGN KEY (parent_id) REFERENCES public.repository_rows(id);
...
--
-- Name: forms fk_rails_c11d5bb74f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_c11d5bb74f FOREIGN KEY (team_id) REFERENCES public.teams(id);
...
--
-- Name: step_texts fk_rails_c3914532a0; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.step_texts
    ADD CONSTRAINT fk_rails_c3914532a0 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
...
--
-- Name: taggings fk_rails_c4534a4738; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.taggings
    ADD CONSTRAINT fk_rails_c4534a4738 FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: team_assignments fk_rails_c7dc6d9541; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team_assignments
    ADD CONSTRAINT fk_rails_c7dc6d9541 FOREIGN KEY (team_id) REFERENCES public.teams(id);


--
-- Name: form_field_values fk_rails_c7eaab4578; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_field_values
    ADD CONSTRAINT fk_rails_c7eaab4578 FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: user_groups fk_rails_c9a5c83c8d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_groups
    ADD CONSTRAINT fk_rails_c9a5c83c8d FOREIGN KEY (last_modified_by_id) REFERENCES public.users(id);


--
-- Name: protocol_repository_rows fk_rails_c9be8b318d; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.protocol_repository_rows
    ADD CONSTRAINT fk_rails_c9be8b318d FOREIGN KEY (repository_row_id) REFERENCES public.repository_rows(id);


--
-- Name: form_fields fk_rails_c9f3ed2f58; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_fields
    ADD CONSTRAINT fk_rails_c9f3ed2f58 FOREIGN KEY (last_modified_by_id) REFERENCES public.users(id);
...
--
-- Name: repository_row_connections fk_rails_cd62e7162f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.repository_row_connections
    ADD CONSTRAINT fk_rails_cd62e7162f FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: user_group_assignments fk_rails_d4161003d9; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_assignments
    ADD CONSTRAINT fk_rails_d4161003d9 FOREIGN KEY (team_id) REFERENCES public.teams(id);


--
-- Name: user_group_assignments fk_rails_d529fc409c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_group_assignments
    ADD CONSTRAINT fk_rails_d529fc409c FOREIGN KEY (user_group_id) REFERENCES public.user_groups(id);
...
--
-- Name: result_texts fk_rails_db2139dce3; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.result_texts
    ADD CONSTRAINT fk_rails_db2139dce3 FOREIGN KEY (archived_by_id) REFERENCES public.users(id);


--
-- Name: storage_locations fk_rails_db601e6a4c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.storage_locations
    ADD CONSTRAINT fk_rails_db601e6a4c FOREIGN KEY (parent_id) REFERENCES public.storage_locations(id);
...
--
-- Name: user_groups fk_rails_e74921894f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_groups
    ADD CONSTRAINT fk_rails_e74921894f FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: form_field_values fk_rails_e8be89a681; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.form_field_values
    ADD CONSTRAINT fk_rails_e8be89a681 FOREIGN KEY (submitted_by_id) REFERENCES public.users(id);


--
-- Name: forms fk_rails_e913d6d77f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_e913d6d77f FOREIGN KEY (last_modified_by_id) REFERENCES public.users(id);
...
--
-- Name: forms fk_rails_eec95cd377; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_eec95cd377 FOREIGN KEY (created_by_id) REFERENCES public.users(id);
...
--
-- Name: step_results fk_rails_f2e2f24964; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.step_results
    ADD CONSTRAINT fk_rails_f2e2f24964 FOREIGN KEY (step_id) REFERENCES public.steps(id);


--
-- Name: results fk_rails_f325513911; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.results
    ADD CONSTRAINT fk_rails_f325513911 FOREIGN KEY (pinned_by_id) REFERENCES public.users(id);
...
--
-- Name: forms fk_rails_fb932ec390; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.forms
    ADD CONSTRAINT fk_rails_fb932ec390 FOREIGN KEY (restored_by_id) REFERENCES public.users(id);
